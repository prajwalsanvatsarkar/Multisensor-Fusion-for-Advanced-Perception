...
<img width="1624" height="559" alt="image" src="https://github.com/user-attachments/assets/d7ce2242-70ff-4629-86e2-2b3982b46c8c" />
...
- The final step evaluates the accuracy using Mean Absolute Error (MAE) and Root Mean Square Error (RMSE), achieving a MAE of 3.49 meters and RMSE of 3.37 meters, indicating good overall accuracy.
- To resolve these errors, in future instead of filtering projected points in specified bounding box, a segmented mask of vehicle can be considered for estimating the actual vehicle boundary.
